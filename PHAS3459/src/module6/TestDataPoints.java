...
public class TestDataPoints {
	...
	private static DataPoint parseLine(String line) {
		// Static method to take in line of data and parse into x, y and yerr objects
		// outputting a datapoint with these objects
	...
	// Static method which reads data from URL file and returns arrayList of
	// datapoint variables
	...
	public static void main(String[] args) {
		...
		try {
			...
			ArrayList<DataPoint> data = dataFromURL(
