...
public class MetricCutoffOriginal implements MetricInterface {
	...
	public double cutOff(String urlSignal, String urlBackground, double lowerBoundary) throws MalformedURLException, IOException {
		...
		while (minEnergy <= 3.0) {
			...
			double sbRatio = counterSignal / counterBackground;
		...
		System.out.println("Max signal-background ratio: "+maxSbRatio);
		System.out.println("Max Signal-background ratio energy: "+maxSbRatioEnergy);
